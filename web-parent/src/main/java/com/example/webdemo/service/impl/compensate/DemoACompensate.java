 ...
 */
@Component
public class DemoACompensate extends AbstractCompensateService {
    private static final Logger log = LoggerFactory.getLogger(DemoACompensate.class);

    @Override
    public void doCompensate(Compensate compensate) {
        log.info("DemoACompensate begin,serial:{},param:{}", compensate.getSerialNo(),
    ...
    public String getBizType() {
        return EnumCompensateType.DEMO_A.getCode();
    }
